...
export default function AATesAkhir({ navigation, route }) {
    ...
    const sendServer = () => {
        ...
        console.log(kirim);
        axios.post(apiURL + 'add_tesakhir', kirim).then(res => {
            console.log(res.data);
            if (res.data.status == 200) {
                Alert.alert(MYAPP, 'Nilai Tes Akhir Kamu: ' + (totalNilai / data.length) * 100);
                showMessage({
                    type: 'success',
